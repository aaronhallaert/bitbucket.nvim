...
M.abs_path_to_git_relative_path = function(abs_filename)
    ...
    if git_dir and git_dir ~= "" then
        ...
        git_dir = escape_chars(M.path.sanitize(vim.fn.getcwd()) .. "/")
        return string.gsub(abs_filename, git_dir, "")
    end
end
...
M.git_relative_path = function(bufnr)
    ...
    return M.abs_path_to_git_relative_path(abs_filename)
end
